...
//	public Financing() {
//	}
	/* Caso específico de comentar o construtor sem argumentos para ter uma garantia que 
	 * só seja possível instânciar a classe Financing com argumentos, para não 
	 * apresentar erro nos outros métodos de cálculo.*/
